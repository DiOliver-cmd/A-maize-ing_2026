from dfs_mock import dfs_grid, path_to_directions

def run_test_dfs_9x9() -> None:
    ...
    print("--- Executando Teste DFS em Grade 9x9 ---")
    caminho_calculado = dfs_grid(mock_grid_9x9, start_position, goal_position)
    ...
    if caminho_calculado is not None:
        ...
        print("✅ Sucesso: O DFS encontrou uma rota válida até a saída!")
    else:
